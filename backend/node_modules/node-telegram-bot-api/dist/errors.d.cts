...
export declare class FatalError extends BaseError {
...
export declare class TelegramError extends BaseError {
    readonly response?: TelegramErrorResponse;
    constructor(message: string, response?: TelegramErrorResponse);
}
export declare const errors: {
    readonly BaseError: typeof BaseError;
    readonly FatalError: typeof FatalError;
    readonly ParseError: typeof ParseError;
    readonly TelegramError: typeof TelegramError;
};
